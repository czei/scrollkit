...
from scrollkit.effects import EffectsEngine
from scrollkit.effects.effects import SparkleEffect, EdgeGlowEffect, RainbowCycleEffect
...
class TestEffectsEngine:
    ...
    async def test_remove_expired_effects(self, mock_display):
        ...
        with patch('scrollkit.effects.effects.get_time') as mock_get_time:
