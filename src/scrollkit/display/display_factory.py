...
def create_display(config=None):
    ...
    if is_dev_mode() and use_simple_simulator():
        ...
        try:
            # Future: from scrollkit.display.generic_simulator import GenericSimulatorDisplay
    ...
    try:
        # Future: from scrollkit.display.generic_display import GenericDisplay
        ...
        if is_circuitpython():
            try:
                # Future: from scrollkit.display.generic_hardware import GenericHardwareDisplay
            ...
            try:
                # Future: from scrollkit.display.generic_sldk import GenericSLDKDisplay
