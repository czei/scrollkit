...
class TestMinimalLEDApp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patches = [
            patch('sldk.app.minimal.CircuitPythonApp'),
            patch('sldk.app.minimal.StandardPythonApp'),
            patch('sldk.app.minimal.get_memory_info', return_value=self.mock_memory_info),
        ]
    ...
    def test_memory_auto_detection(self):
        ...
        with patch('sldk.app.minimal.get_memory_info') as mock_mem:
...
class TestSLDKTestingPatterns(unittest.TestCase):
    ...
    def test_environment_detection_pattern(self):
        ...
        with patch('sys.implementation', mock_impl):
            with patch('sldk.app.minimal.get_memory_info') as mock_mem:
                with patch('sldk.app.minimal.CircuitPythonApp') as mock_cp_app:
